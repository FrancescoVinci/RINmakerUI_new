...
(function (global, factory) {
  ...
  */
  ...
  const commonPropTypes = {
    ...
    graphData: propTypesExports.shape({
      nodes: propTypesExports.arrayOf(propTypesExports.object).isRequired,
      links: propTypesExports.arrayOf(propTypesExports.object).isRequired
    }),
    backgroundColor: propTypesExports.string,
    nodeRelSize: propTypesExports.number,
    nodeId: propTypesExports.string,
    nodeLabel: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    nodeVal: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    nodeVisibility: propTypesExports.oneOfType([propTypesExports.bool, propTypesExports.string, propTypesExports.func]),
    nodeColor: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    nodeAutoColorBy: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    onNodeHover: propTypesExports.func,
    onNodeClick: propTypesExports.func,
    linkSource: propTypesExports.string,
    linkTarget: propTypesExports.string,
    linkLabel: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    linkVisibility: propTypesExports.oneOfType([propTypesExports.bool, propTypesExports.string, propTypesExports.func]),
    linkColor: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    linkAutoColorBy: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    linkWidth: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkCurvature: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkDirectionalArrowLength: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkDirectionalArrowColor: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    linkDirectionalArrowRelPos: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkDirectionalParticles: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkDirectionalParticleSpeed: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkDirectionalParticleWidth: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkDirectionalParticleColor: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    onLinkHover: propTypesExports.func,
    onLinkClick: propTypesExports.func,
    dagMode: propTypesExports.oneOf(['td', 'bu', 'lr', 'rl', 'zin', 'zout', 'radialin', 'radialout']),
    dagLevelDistance: propTypesExports.number,
    dagNodeFilter: propTypesExports.func,
    onDagError: propTypesExports.func,
    d3AlphaMin: propTypesExports.number,
    d3AlphaDecay: propTypesExports.number,
    d3VelocityDecay: propTypesExports.number,
    warmupTicks: propTypesExports.number,
    cooldownTicks: propTypesExports.number,
    cooldownTime: propTypesExports.number,
    onEngineTick: propTypesExports.func,
    onEngineStop: propTypesExports.func,
    getGraphBbox: propTypesExports.func
  };
  const pointerBasedPropTypes = {
    zoomToFit: propTypesExports.func,
    onNodeRightClick: propTypesExports.func,
    onNodeDrag: propTypesExports.func,
    onNodeDragEnd: propTypesExports.func,
    onLinkRightClick: propTypesExports.func,
    linkHoverPrecision: propTypesExports.number,
    onBackgroundClick: propTypesExports.func,
    onBackgroundRightClick: propTypesExports.func,
    enablePointerInteraction: propTypesExports.bool,
    enableNodeDrag: propTypesExports.bool
  };
  const threeBasedPropTypes = {
    showNavInfo: propTypesExports.bool,
    nodeOpacity: propTypesExports.number,
    nodeResolution: propTypesExports.number,
    nodeThreeObject: propTypesExports.oneOfType([propTypesExports.object, propTypesExports.string, propTypesExports.func]),
    nodeThreeObjectExtend: propTypesExports.oneOfType([propTypesExports.bool, propTypesExports.string, propTypesExports.func]),
    linkOpacity: propTypesExports.number,
    linkResolution: propTypesExports.number,
    linkCurveRotation: propTypesExports.oneOfType([propTypesExports.number, propTypesExports.string, propTypesExports.func]),
    linkMaterial: propTypesExports.oneOfType([propTypesExports.object, propTypesExports.string, propTypesExports.func]),
    linkThreeObject: propTypesExports.oneOfType([propTypesExports.object, propTypesExports.string, propTypesExports.func]),
    linkThreeObjectExtend: propTypesExports.oneOfType([propTypesExports.bool, propTypesExports.string, propTypesExports.func]),
    linkPositionUpdate: propTypesExports.func,
    linkDirectionalArrowResolution: propTypesExports.number,
    linkDirectionalParticleResolution: propTypesExports.number,
    forceEngine: propTypesExports.oneOf(['d3', 'ngraph']),
    ngraphPhysics: propTypesExports.object,
    numDimensions: propTypesExports.oneOf([1, 2, 3])
  };
  const ForceGraph2DPropTypes = Object.assign({}, commonPropTypes, pointerBasedPropTypes, {
    linkLineDash: propTypesExports.oneOfType([propTypesExports.arrayOf(propTypesExports.number), propTypesExports.string, propTypesExports.func]),
    nodeCanvasObjectMode: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    nodeCanvasObject: propTypesExports.func,
    nodePointerAreaPaint: propTypesExports.func,
    linkCanvasObjectMode: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    linkCanvasObject: propTypesExports.func,
    linkPointerAreaPaint: propTypesExports.func,
    autoPauseRedraw: propTypesExports.bool,
    minZoom: propTypesExports.number,
    maxZoom: propTypesExports.number,
    enableZoomInteraction: propTypesExports.bool,
    enablePanInteraction: propTypesExports.bool,
    onZoom: propTypesExports.func,
    onZoomEnd: propTypesExports.func,
    onRenderFramePre: propTypesExports.func,
    onRenderFramePost: propTypesExports.func
  });
  Object.assign({}, commonPropTypes, pointerBasedPropTypes, threeBasedPropTypes, {
    enableNavigationControls: propTypesExports.bool,
    controlType: propTypesExports.oneOf(['trackball', 'orbit', 'fly']),
    rendererConfig: propTypesExports.object,
    extraRenderers: propTypesExports.arrayOf(propTypesExports.shape({
      render: propTypesExports.func.isRequired
    }))
  });
  Object.assign({}, commonPropTypes, threeBasedPropTypes, {
    nodeDesc: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func]),
    linkDesc: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.func])
  });
  Object.assign({}, commonPropTypes, threeBasedPropTypes, {
    markerAttrs: propTypesExports.object,
    yOffset: propTypesExports.number,
    glScale: propTypesExports.number
  });
